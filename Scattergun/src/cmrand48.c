 ...
 * ABSTRACT
 *
 * Continuously output binary numbers generated by the C library's mrand48(3)
 * function. These numbers will range in value from -2^31 to 2^31. If an
 * argument is specified, it is used to seed the pseudo-random number generator.
 */
